...
public class Code {
	...
	public Code(Integer divisionId, Integer districtId, Integer subDistrictId, Integer cityId, Integer postalId,
			Integer areaId, String codeType, String codeName, String description, Boolean status, String filler1,
